...
def create_groups_and_permissions(sender, **kwargs):
    ...
    reader_group = create_group_with_permissions('Reader', reader_permissions)
    journalist_group = create_group_with_permissions('Journalist', journalist_permissions) 
    editor_group = create_group_with_permissions('Editor', editor_permissions)
