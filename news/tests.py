...
class NewsModelsTest(TestCase):
    ...
    def test_article_creation(self):
        ...
        self.assertEqual(self.article.journalist.username, "test_journalist1")
    ...
    def test_newsletter_creation(self):
        ...
        self.assertFalse(self.newsletter.approved)
        self.assertEqual(self.newsletter.journalist.username, "test_journalist1")
